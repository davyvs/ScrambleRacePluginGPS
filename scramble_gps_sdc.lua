-- ============================================================
-- Scramble GPS SDC v1 — ChilledDVS Sierra de Cadiz Servers
...
local lapRouteNames = { "Grazalema Loop", "Mountain Pass", "Cadiz Road Tour" }
...
local function showMain()
    ...
    -- Self-service dest picker (P2P / idle)
...
-- ── [7] registerOnlineExtra DISPATCHER ───────────────────
...
-- ── [10] UPDATE HELPERS & script.update ──────────────────
